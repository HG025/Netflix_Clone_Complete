...
import com.netflix.clone.com.netflix.clone.dto.request.ChangePasswordRequest;
import com.netflix.clone.com.netflix.clone.dto.request.EmailRequest;
import com.netflix.clone.com.netflix.clone.dto.request.LoginRequest;
import com.netflix.clone.com.netflix.clone.dto.request.resetPasswordRequest;
...
public class AuthController {
    ...
    public ResponseEntity<LoginResponse> login(@Valid @RequestBody LoginRequest loginRequest){
        LoginResponse respone = authService.login(loginRequest.getEmail(), loginRequest.getPassword());
